...
function changePerson(index) {
  // change person data
  console.log($("#sigma" + index).data('name'));
  $("#name").text($("#sigma" + index).data('name'));
  $("#git-username").text($("#sigma" + index).data('git-username'));
  $("#shoutout").text($("#sigma" + index).data('shoutout'));
